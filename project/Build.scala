      ...
      settings = Defaults.defaultSettings ++ packSettings ++
        Seq(
          ...
          libraryDependencies ++= Seq(
            ...
            "org.apache.lucene" % "lucene-analyzers-kuromoji" % "5.2.0",
            "org.apache.lucene" % "lucene-analyzers-icu" % "5.2.0",
            "org.apache.lucene" % "lucene-queries" % "5.2.0",
            "org.apache.lucene" % "lucene-queryparser" % "5.2.0",
            "org.apache.lucene" % "lucene-suggest" % "5.2.0",
