...
/**
 * 連接頻度LR法にしたがい複合名詞CNのスコアを計算する。
 * 
 * @see LRCompoundNounScorer#score(String)
 * @since 0.3
 */
public class ConcatFreqLRCompoundNounScorer extends LRCompoundNounScorer {

  public ConcatFreqLRCompoundNounScorer(IndexReader reader, String delimiter, String fieldNameCn,
